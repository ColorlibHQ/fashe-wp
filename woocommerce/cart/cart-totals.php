...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-bs-title="<?php esc_attr_e( 'Subtotal', 'fashe' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				...
				<td data-bs-title="<?php esc_attr_e( 'Shipping', 'fashe' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			...
			<td data-bs-title="<?php esc_attr_e( 'Total', 'fashe' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
