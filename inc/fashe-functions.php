...
function fashe_theme_logo( $class = '' ) {
	...
	$image_url = wp_get_attachment_image_src( absint( $custom_logo_id ), 'full' );
...
function fashe_inline_bg_img( $bg_url ) {
	$bg = '';
...
function fashe_sidebar_opt() {
	...
	$sidebar_opt = fashe_opt( 'fashe-sidebarlayouts-settings' );
...
function fashe_global_header_opt() {
	...
	$sidebar_opt = fashe_opt( 'fashe-header-layout' );
