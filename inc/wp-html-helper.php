...
// image default alt
if ( ! function_exists( 'fashe_img_default_alt' ) ) {
	function fashe_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'fashe_img_tag' ) ) {
	function fashe_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'fashe_anchor_tag' ) ) {
	function fashe_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'fashe_heading_tag' ) ) {
	function fashe_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'fashe_paragraph_tag' ) ) {
	function fashe_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'fashe_other_tag' ) ) {
	function fashe_other_tag( array $args ) {
...
// Button Element
if ( ! function_exists( 'fashe_button_element ' ) ) {
	function fashe_button_element( array $args ) {
