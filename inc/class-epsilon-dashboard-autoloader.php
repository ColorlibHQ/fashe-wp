...
class Epsilon_Dashboard_Autoloader {
	...
	public function load( $class = '' ) {
		...
		$directories = array(
			...
			FASHE_DIR_PATH_LIBS . 'epsilon-theme-dashboard/inc/helpers/',
			FASHE_DIR_PATH_LIBS . 'epsilon-theme-dashboard/inc/misc/',
			FASHE_DIR_PATH_LIBS . 'epsilon-theme-dashboard/inc/misc/demo-generators/',
			FASHE_DIR_PATH_LIBS . 'epsilon-theme-dashboard/inc/misc/epsilon-tracking/',
			FASHE_DIR_PATH_LIBS . 'epsilon-theme-dashboard/inc/misc/epsilon-tracking/trackers/',
		);
