			...
			switch ( $prop ) {
				case 'background-color':
					$temp = array(
						...
						'label'       => __( 'Background color', 'fashe' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'epsilon-color-picker',
						'mode'        => 'hex',
				...
				case 'background-color-opacity':
					$temp = array(
						...
						'label'       => __( 'Background color opacity', 'fashe' ),
						'description' => '',
						'type'        => 'epsilon-slider',
				...
				case 'background-image':
					$temp = array(
						...
						'label'       => __( 'Background image', 'fashe' ),
						'description' => '',
						'type'        => 'epsilon-image',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'group'       => 'styling',
				...
				case 'background-position':
					$temp = array(
						...
						'label'       => __( 'Background position', 'fashe' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'topleft'     => __( 'Top Left', 'fashe' ),
							'top'         => __( 'Top', 'fashe' ),
							'topright'    => __( 'Top Right', 'fashe' ),
							'left'        => __( 'Left', 'fashe' ),
							'center'      => __( 'Center', 'fashe' ),
							'right'       => __( 'Right', 'fashe' ),
							'bottomleft'  => __( 'Bottom Left', 'fashe' ),
							'bottom'      => __( 'Bottom', 'fashe' ),
							'bottomright' => __( 'Bottom Right', 'fashe' ),
						),
					);
				...
				case 'background-repeat':
					$temp = array(
						...
						'label'       => __( 'Background repeat', 'fashe' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'no-repeat' => __( 'No Repeat', 'fashe' ),
							'repeat'    => __( 'Repeat', 'fashe' ),
							'repeat-y'  => __( 'Repeat Y', 'fashe' ),
							'repeat-x'  => __( 'Repeat X', 'fashe' ),
						),
					);
				...
				case 'background-size':
					$temp = array(
						...
						'label'       => __( 'Background size', 'fashe' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'cover'   => __( 'Cover', 'fashe' ),
							'contain' => __( 'Contain', 'fashe' ),
							'initial' => __( 'Initial', 'fashe' ),
						),
					);
				...
				case 'background-parallax':
					$temp = array(
						...
						'label'       => __( 'Background parallax', 'fashe' ),
						'description' => '',
				...
				case 'background-video':
					$temp = array(
						...
						'label'       => __( 'Background video', 'fashe' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'text',
						'group'       => 'styling',
			...
			switch ( $prop ) {
				case 'column-alignment':
					$temp = array(
						...
						'label'   => __( 'Horizontal alignment', 'fashe' ),
						'group'   => 'layout',
				...
				case 'column-vertical-alignment':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Vertical alignment', 'fashe' ),
						'group'   => 'layout',
				...
				case 'row-title-align':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Title & description alignment', 'fashe' ),
						'group'   => 'layout',
