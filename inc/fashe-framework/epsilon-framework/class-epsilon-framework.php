...
class Epsilon_Framework {
	 ...
	 * @var mixed|string
	 */
	private $path = '/inc/fashe-framework';
	/**
	...
	public function customizer_enqueue_scripts() {
		...
		wp_localize_script( 'epsilon-object', 'EpsilonTranslations', array(
			'remove'     => esc_html__( 'Remove', 'fashe' ),
			'add'        => esc_html__( 'Add', 'fashe' ),
			'selectFile' => esc_html__( 'Upload image', 'fashe' ),
			'row'        => esc_html__( 'Row', 'fashe' ),
		) );
