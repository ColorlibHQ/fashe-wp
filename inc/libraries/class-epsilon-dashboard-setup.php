...
class Epsilon_Dashboard_Setup {
	...
	public function add_admin_notice() {
		...
		if ( empty( $this->notice ) ) {
			...
			$this->notice .= '<h1>' . sprintf( esc_html__( 'Welcome to %1$s', 'fashe' ), $this->theme['theme-name'] ) . '</h1>';
			$this->notice .= '<p>';
			$this->notice .=
				sprintf( /* Translators: Notice */
					esc_html__( 'Welcome! Thank you for choosing %3$s! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%2$s.', 'fashe' ),
			...
			$this->notice .= '<p><a href="' . esc_url( admin_url( '?page=epsilon-onboarding' ) ) . '" class="button button-primary button-hero" style="text-decoration: none;"> ' . sprintf( esc_html__( 'Get started with %1$s', 'fashe' ), $this->theme['theme-name'] ) . '</a></p>';
		}
	...
	public function get_steps() {
		return array(
			array(
				'id'       => 'landing',
				'title'    => __( 'Welcome to Fashe', 'fashe' ),
				'content'  => array(
					'paragraphs' => array(
						__( ' This wizard will set up your theme, install plugins and import demo content. It is optional & should take less than a minute.', 'fashe' ),
					),
				),
				'progress' => __( 'Getting Started', 'fashe' ),
				'buttons'  => array(
					'next' => array(
						'action' => 'next',
						'label'  => __( 'Let\'s get started <span class="dashicons dashicons-arrow-right-alt2"></span>', 'fashe' ),
					),
				),
			),
			array(
				'id'       => 'plugins',
				'title'    => __( 'Install Recommended Plugins', 'fashe' ),
				'content'  => array(
					'paragraphs' => array(
						__( 'Fashe integrates tightly with a few plugins that we recommend installing to get the full theme experience, as we\'ve intended it to be. This is an optional step, but we recommend installing them as we think these hand-picked plugins work really nice with Fashe and help enhance the overall experience.', 'fashe' ),
					),
				),
				'progress' => __( 'Plugins', 'fashe' ),
				'buttons'  => array(
					'next' => array(
						'action' => 'next',
						'label'  => __( 'Next <span class="dashicons dashicons-arrow-right-alt2"></span>', 'fashe' ),
					),
				),
			),
			array(
				'id'       => 'enjoy',
				'title'    => __( 'Almost ready', 'fashe' ),
				'content'  => array(
					'paragraphs' => array(
						__( 'Your new theme has been all set up. Enjoy your new theme by <a href="https://www.colorlib.com">Colorlib</a>.', 'fashe' ),
						$this->get_permission_content(),
					),
				),
				'progress' => __( 'Finished', 'fashe' ),
				'buttons'  => array(
					'next' => array(
						'action' => 'customizer',
						'label'  => __( 'Allow & Finish', 'fashe' ),
					),
				),
			),
		);
	...
	public function get_permission_content() {
		...
		$html .= '<a href="#hidden-permissions" id="hidden-permissions-toggle"> ' . __( 'What permissions are being granted', 'fashe' ) . ' <span class="dashicons dashicons-arrow-down"></span></a>';
		$html .= '<div id="hidden-permissions" >
			<ul>
				<li>
					<span class="dashicons dashicons-admin-users"></span>
					<span class="content">
						<strong>' . __( 'YOUR PROFILE OVERVIEW', 'fashe' ) . '</strong>
						<small>' . __( 'Name and email address', 'fashe' ) . '</small>		
					</span>
				</li>
				<li>
					<span class="dashicons dashicons-admin-settings"></span>
					<span class="content">
						<strong>' . __( 'YOUR SITE OVERVIEW', 'fashe' ) . '</strong>
						<small>' . __( 'Site URL, WP Version, PHP Version, plugins and themes', 'fashe' ) . '</small>		
					</span>
				</li>
				<li>
					<span class="dashicons dashicons-admin-plugins"></span>
					<span class="content">
						<strong>' . __( 'CURRENT PLUGIN EVENTS', 'fashe' ) . '</strong>
						<small>' . __( 'Activation, deactivation and uninstall', 'fashe' ) . '</small>		
					</span>
				</li>
			</ul>
			</div>
	...
	public function get_actions() {
		...
		return array(
			...
			array(
				...
				'actions'     => array(
					array(
						'label'   => Epsilon_Init_Notify_System::plugin_verifier( 'contact-form-7', 'installed', 'Contact Form 7', 'verify_cf7' ) ? __( 'Activate Plugin', 'fashe' ) : __( 'Install Plugin', 'fashe' ),
						'type'    => 'handle-plugin',
			...
			array(
				'id'          => 'fashe-check-cm',
				'title'       => Epsilon_Init_Notify_System::plugin_verifier( 'fashe-companion', 'title', 'Fashe Companion' ),
				'description' => Epsilon_Init_Notify_System::plugin_verifier( 'fashe-companion', 'description', 'Fashe Companion' ),
				'plugin_slug' => 'fashe-companion',
				'state'       => false,
				'check'       => defined( 'FASHE_COMPANION_VERSION' ),
				'actions'     => array(
					array(
						'label'   => Epsilon_Init_Notify_System::plugin_verifier( 'fashe-companion', 'installed', 'Fashe Companion' ) ? __( 'Activate Plugin', 'fashe' ) : __( 'Install Plugin', 'fashe' ),
						'type'    => 'handle-plugin',
						'handler' => Epsilon_Init_Notify_System::plugin_verifier( 'fashe-companion', 'installed', 'Fashe Companion' ),
					),
				),
			),
			array(
				'id'          => 'fashe-check-elementor',
				...
				'actions'     => array(
					array(
						'label'   => Epsilon_Init_Notify_System::plugin_verifier( 'elementor', 'installed', 'Elementor' ) ? __( 'Activate Plugin', 'fashe' ) : __( 'Install Plugin', 'fashe' ),
						'type'    => 'handle-plugin',
			...
			array(
				...
				'actions'     => array(
					array(
						'label'   => Epsilon_Init_Notify_System::plugin_verifier( 'woocommerce', 'installed', 'Woocommerce' ) ? __( 'Activate Plugin', 'fashe' ) : __( 'Install Plugin', 'fashe' ),
						'type'    => 'handle-plugin',
			...
			array(
				...
				'actions'     => array(
					array(
						'label'   => Epsilon_Init_Notify_System::plugin_verifier( 'one-click-demo-import', 'installed', 'One Click Demo Import' ) ? __( 'Activate Plugin', 'fashe' ) : __( 'Install Plugin', 'fashe' ),
						'type'    => 'handle-plugin',
	...
	public function get_tabs( $setup = array() ) {
		...
		return array(
			array(
				...
				'title'   => esc_html__( 'Getting Started', 'fashe' ),
				'hidden'  => false,
				'type'    => 'info',
				'content' => array(
					array(
						'title'     => esc_html__( 'Step 1 - Implement recommended actions', 'fashe' ),
						'paragraph' => esc_html__( 'We compiled a list of steps for you, to take make sure the experience you will have using one of our products is very easy to follow.', 'fashe' ),
						'action'    => '<a href="' . esc_url( admin_url() . '?page=epsilon-onboarding' ) . '" class="button button-primary">' . __( 'Launch wizard', 'fashe' ) . '</a>',
					),
					array(
						'title'     => esc_html__( 'Step 2 - Check our documentation', 'fashe' ),
						'paragraph' => esc_html__( 'Even if you are a long-time WordPress user, we still believe you should give our documentation a very quick Read.', 'fashe' ),
						'action'    => '<a target="_blank" href="https://colorlib.com/">' . __( 'Full documentation', 'fashe' ) . '</a>',
					),
					array(
						'title'     => esc_html__( 'Step 3 - Customize everything', 'fashe' ),
						'paragraph' => esc_html__( 'Using the WordPress Customizer you can easily customize every aspect of the theme.', 'fashe' ),
						'action'    => '<a target="_blank" href="' . esc_url( admin_url() . 'customize.php' ) . '" class="button button-primary">' . esc_html__( 'Go to Customizer', 'fashe' ) . '</a>',
					),
					array(
						'title'     => esc_html__( 'Lend a hand and share your thoughts', 'fashe' ),
						'paragraph' => vsprintf(
						// Translators: 1 is Theme Name, 2 is opening Anchor, 3 is closing.
							__( 'We worked hard on making %1$s the best one out there. We are interested in hearing your thoughts about %1$s and what we could do to make it even better.<br/> <br/>', 'fashe' ),
							array(
								$theme->get( 'Name' ),
							)
						),
						'action'    => '<a class="button button-feedback" target="_blank" href="https://bit.ly/feedback-fashe">Have your say</a><br/>',
						'type'      => 'standout',
					),
				),
			),
			array(
				'id'      => 'epsilon-actions',
				'title'   => esc_html__( 'Actions', 'fashe' ),
				'type'    => 'actions',
