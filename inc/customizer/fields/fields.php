...
Epsilon_Customizer::add_field(
	...
	array(
		...
		'description'       => sprintf( __( 'Set instagram access token. To get access token %1$s click here %2$s.', 'fashe' ), '<a target="_blank" href="' . esc_url( $url ) . '">', '</a>' ),
		'section'           => 'fashe_general_options_section',
		'sanitize_callback' => 'sanitize_text_field',
		'default'           => '',
...
Epsilon_Customizer::add_field(
	...
	array(
		...
		'description'       => sprintf( __( 'Set google map api key. To get api key %1$s click here %2$s.', 'fashe' ), '<a target="_blank" href="' . esc_url( $url ) . '">', '</a>' ),
		'section'           => 'fashe_general_options_section',
		'sanitize_callback' => 'sanitize_text_field',
		'default'           => '',
