...
function fashe_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'fashe' ),
        'next_string'     => esc_html__( '&raquo;', 'fashe' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'fashe_pagination_defaults', $defaults )
    );
