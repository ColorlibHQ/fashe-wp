 ...
 */
	...
	class fashe_Enqueue{
		...
		public function fashe_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'fashe_frontend_enqueue_scripts', ) );
		}

		public function fashe_frontend_enqueue_scripts( ){
